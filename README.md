...
[![jcenter](https://api.bintray.com/packages/scottpierce/maven/kotlin-html/images/download.svg?version=0.3.1)](https://bintray.com/beta/#/scottpierce/maven/kotlin-html/0.3.1?tab=overview)
...
dependencies {
    ...
    implementation("dev.scottpierce.kotlin-html:kotlin-html-writer-jvm:0.3.1")
    
    // If you are using Ktor, you can use this as well
    implementation("dev.scottpierce.kotlin-html:kotlin-html-ktor:0.3.1")
}
```
...
kotlin {
    commonMain {
        dependencies {
            implementation("dev.scottpierce.kotlin-html:kotlin-html-writer:0.3.1")
        }    
    }
}
```
