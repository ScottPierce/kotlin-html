...
[![jcenter](https://api.bintray.com/packages/scottpierce/maven/kotlin-html/images/download.svg?version=0.6.3)](https://bintray.com/beta/#/scottpierce/maven/kotlin-html/0.6.3?tab=overview)
...
dependencies {
    ...
    implementation("dev.scottpierce.kotlin-html:kotlin-html-writer-jvm:0.6.3")
    
    // If you are using Ktor, you can use this as well
    implementation("dev.scottpierce.kotlin-html:kotlin-html-ktor:0.6.3")
}
```
...
kotlin {
    commonMain {
        dependencies {
            implementation("dev.scottpierce.kotlin-html:kotlin-html-writer:0.6.3")
        }    
    }
}
```
...
```Kotlin
dependencies {
    implementation("dev.scottpierce.kotlin-html:kotlin-html-style-builder:0.6.3")
}
```
...
```Kotlin
dependencies {
    implementation("dev.scottpierce.kotlin-html:kotlin-html-style-builder-phone:0.6.3")
    implementation("dev.scottpierce.kotlin-html:kotlin-html-style-builder-tablet:0.6.3")
    implementation("dev.scottpierce.kotlin-html:kotlin-html-style-builder-desktop:0.6.3")
}
```
