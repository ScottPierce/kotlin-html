...
[![jcenter](https://api.bintray.com/packages/scottpierce/maven/kotlin-html/images/download.svg?version=0.7.16)](https://bintray.com/beta/#/scottpierce/maven/kotlin-html/0.7.16?tab=overview)
...
dependencies {
    ...
    implementation("dev.scottpierce.kotlin-html:kotlin-html-writer-jvm:0.7.16")
    
    // If you are using Ktor, you can use this as well
    implementation("dev.scottpierce.kotlin-html:kotlin-html-ktor:0.7.16")
}
```
...
kotlin {
    commonMain {
        dependencies {
            implementation("dev.scottpierce.kotlin-html:kotlin-html-writer:0.7.16")
        }    
    }
}
```
...
```Kotlin
dependencies {
    implementation("dev.scottpierce.kotlin-html:kotlin-html-style-builder:0.7.16")
}
```
...
```Kotlin
dependencies {
    implementation("dev.scottpierce.kotlin-html:kotlin-html-style-builder-phone:0.7.16")
    implementation("dev.scottpierce.kotlin-html:kotlin-html-style-builder-tablet:0.7.16")
    implementation("dev.scottpierce.kotlin-html:kotlin-html-style-builder-desktop:0.7.16")
}
```
